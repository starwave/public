...
struct ContentView: View, WallpaperServiceDelegate {
    ...
    private let interval: TimeInterval = 1 * 60 * 60 // 1 hours
    ...
    func isBackgroundTaskSupported() -> Bool {
        Bundle.main.object(forInfoDictionaryKey: "Permitted background task scheduler identifiers") != nil
    }
